...
- `templates/` — i 3 template master (osteria.html, pizzeria.html, elegante.html).
  NON SI TOCCANO MAI: sono gli stampi da cui nasce ogni demo. Possono restare
  pubblici su GitHub senza problemi.
